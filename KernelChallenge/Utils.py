'''
Utils -- Kernel Methods for Machine Learning 2018-2019
DESFONTAINES Thibault, LELUC Rémi, TALLEC Gauthier
...
'''
X_train_0 = (pd.read_csv(root+ r'/datasets/Xtr0.csv').values).tolist()
X_train_1 = (pd.read_csv(root+r'/datasets/Xtr1.csv').values).tolist()
X_train_2 = (pd.read_csv(root+r'/datasets/Xtr2.csv').values).tolist()

X_train_matrix_0 = (pd.read_csv(root+r'/datasets/Xtr0_mat100.csv',sep=' ',header=None).values)
X_train_matrix_1 = (pd.read_csv(root+r'/datasets/Xtr1_mat100.csv',sep=' ',header=None).values)
X_train_matrix_2 = (pd.read_csv(root+r'/datasets/Xtr2_mat100.csv',sep=' ',header=None).values)

Y_train_0 = (pd.read_csv(root+r'/datasets/Ytr0.csv',sep=',',index_col=0).values)
Y_train_1 = (pd.read_csv(root+r'/datasets/Ytr1.csv',sep=',',index_col=0).values)
Y_train_2 = (pd.read_csv(root+r'/datasets/Ytr2.csv',sep=',',index_col=0).values)

X_test_0 = (pd.read_csv(root+r'/datasets/Xte0.csv').values).tolist()
X_test_1 = (pd.read_csv(root+r'/datasets/Xte1.csv').values).tolist()
X_test_2 = (pd.read_csv(root+r'/datasets/Xte2.csv').values).tolist()

X_test_matrix_0 = (pd.read_csv(root+r'/datasets/Xte0_mat100.csv',sep=' ',header=None).values)
X_test_matrix_1 = (pd.read_csv(root+r'/datasets/Xte1_mat100.csv',sep=' ',header=None).values)
X_test_matrix_2 = (pd.read_csv(root+r'/datasets/Xte2_mat100.csv',sep=' ',header=None).values)


X_train_0 = (np.array(X_train_0)[:,1]).tolist()
X_train_1 = np.array(X_train_1)[:,1].tolist()
X_train_2 = np.array(X_train_2)[:,1].tolist()

X_test_0 = (np.array(X_test_0)[:,1]).tolist()
X_test_1 = np.array(X_test_1)[:,1].tolist()
X_test_2 = np.array(X_test_2)[:,1].tolist()
